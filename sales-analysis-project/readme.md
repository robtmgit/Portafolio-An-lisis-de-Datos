...
The business has access to sales data but lacks clarity on what is driving revenue and profitability. The objective of this analysis is to identify key trends, top-performing products, and factors affecting profit in order to support better decision-making.

---

## 🔹 Dataset

* Superstore Sales Dataset (~51k rows, 21 columns)
* Includes: sales, profit, discount, product, customer, and date information
